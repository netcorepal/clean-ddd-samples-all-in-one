...
using TradingEngine.Web.Application.Queries;
using TradingEngine.Web.Application.IntegrationEventHandlers;
using TradingEngine.Web.Clients;
using TradingEngine.Web.Extensions;
using FastEndpoints;
using Serilog;
...
try
{
    ...
    app.MapHub<TradingEngine.Web.Application.Hubs.ChatHub>("/chat");
