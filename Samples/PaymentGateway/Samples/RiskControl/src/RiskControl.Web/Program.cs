...
using RiskControl.Web.Application.Queries;
using RiskControl.Web.Application.IntegrationEventHandlers;
using RiskControl.Web.Clients;
using RiskControl.Web.Extensions;
using FastEndpoints;
using Serilog;
...
try
{
    ...
    app.MapHub<RiskControl.Web.Application.Hubs.ChatHub>("/chat");
