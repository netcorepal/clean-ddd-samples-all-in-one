...
using PaymentGateway.Web.Application.Queries;
using PaymentGateway.Web.Application.IntegrationEventHandlers;
using PaymentGateway.Web.Clients;
using PaymentGateway.Web.Extensions;
using FastEndpoints;
using Serilog;
...
try
{
    ...
    app.MapHub<PaymentGateway.Web.Application.Hubs.ChatHub>("/chat");
